...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("695101d5-1b81-5434-9529-70430e482717"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter", artifacts_toml) for e in artifacts["tree_sitter"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter; unsupported platform $(triplet(platform_key_abi()))")
else
